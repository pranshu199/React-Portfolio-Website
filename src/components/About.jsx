    ...
    <div name="about" className="w-full h-full bg-[#1d2e47] text-gray-300 p-20">
      <div className="flex flex-col justify-center items-center w-full h-full">
        ...
        <div className="max-w-[1000px] w-full grid sm:grid-cols-2 gap-8 px-4 pb-20">
          ...
          <div>
            <p>
              Creative Full Stack Developer with 2 years of experience building
              and maintaining responsive web applications. Proficient in
              ReactJS, NextJS, TypeScript, Java, JavaScript, MaterialUI, NodeJS,
              CSS plus modern libraries and frameworks.{" "}
            </p>
          </div>
        </div>
      </div>
